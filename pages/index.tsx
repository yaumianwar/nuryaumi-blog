    ...
    <div className="mx-80">
      ...
      <div className="flex justify-center  mb-5 mt-2">
        ...
        <p className='text-sm font-medium text-slate-700'>
          Full time Mother, part time Software Engineer
        </p>
      </div>

      <div className="flex justify-center  mb-10 space-x-3">
        <a href="https://twitter.com/seiraeat" role="button">
          <svg
        ...
        <a href="https://instagram.com/nryaumi" role="button">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            fill="currentColor"
        ...
        <a href="https://www.linkedin.com/in/nuryaumi" role="button">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            fill="currentColor"
        ...
        <a href="https://github.com/yaumianwar" role="button">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            fill="currentColor"
        ...
        <a href="mailto:nuryaumi10@gmail.com" role="button">
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            fill="none" 
            viewBox="0 0 24 24" 
      ...
      <div className="mt-2 flex flex-row-reverse text-cyan-600">
      <Link href="/posts">Older Posts &rarr;</Link>
      </div>
